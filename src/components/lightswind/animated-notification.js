...
const Notification = ({
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("div", {
        className:
          "absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl pointer-events-none",
      }),
      _jsx(Avatar, { user: notification.user, showAvatar: showAvatars }),
      _jsxs("div", {
      ...
      allowDismiss &&
        _jsx("button", {
          ...
          className:
            "flex-shrink-0 w-5 h-5 text-muted-foreground/50 hover:text-muted-foreground transition-all duration-200 hover:scale-110 opacity-0 group-hover:opacity-100",
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      _jsx("div", {
        ...
        children: _jsx(Flipper, {
          flipKey: notes.map((note) => note.id).join(""),
          children: _jsx("div", {
