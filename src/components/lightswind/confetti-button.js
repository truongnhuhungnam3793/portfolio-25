  ...
  "inline-flex items-center justify-center gap-2 font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-r from-green-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700",
      },
      size: {
...
const ConfettiButton = React.forwardRef(
  (
    ...
    return _jsxs("button", {
      ...
      ...props,
      children: [
        loading && _jsx(Loader2, { className: "h-4 w-4 mr-2 animate-spin" }),
        !loading &&
          icon &&
          iconPosition === "left" &&
          _jsx("span", { className: "mr-1", children: icon }),
        children,
        !loading &&
          icon &&
          iconPosition === "right" &&
          _jsx("span", { className: "ml-1", children: icon }),
      ],
    })
  }
)
